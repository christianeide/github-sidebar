...
import { convertMsToSec } from '../../utils/common';
...
export default defineBackground(() => {
	...
	chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
		// We separate async requests and regular requests
		// Async
		...
		// Because of a bug in chrome 99+, we need to always call sendResponse.
